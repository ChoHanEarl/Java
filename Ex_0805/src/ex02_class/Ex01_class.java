...
//작성한 것과 동일하게 각 class별로 도출되어 2개가 된다.
...
public class Ex01_class {
	public static void main(String[] args) {
		...
		c = new Cat(); //new Cat(); 자체를 객체라고 봐도 됨
		//고양이 객체이므로 Cat 타입이라고 하면 객체변수 c의 타입이 Cat으로 되는 것.
		...
		System.out.println("car의 바퀴  수 : " + car.wheel); // 0
		
		car.wheel = 4;
		
		System.out.println("car의 바퀴  수 : " + car.wheel); // 4
		
		Car car2 = new Car();
		
		System.out.println("car2의 바퀴 수 : " + car2.wheel); // 0
		...
		//반환값이 없을 시 void, 반환값이 있는 경우 반환하는 데이터의 타입을 반환형 자리에 명시해야 한다.
