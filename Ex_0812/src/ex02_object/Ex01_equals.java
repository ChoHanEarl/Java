...
public class Ex01_equals {
	public static void main(String[] args) {
		...
		//str1 = "Bye"; //str2도 같은 주소를 참조하니까 str2도 Bye로 바뀌는 게 맞지 않을까? X 주소만 같고 값은 바뀌지 않는다.
		...
		System.out.println("str2 vs str3 : " + (str2 == str3)); // str3는 new로 새롭게 할당받았기 때문에 같은 것을 참조하지 않는다.
