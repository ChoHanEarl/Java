...
public class Ex01_TreeSet {
	public static void main(String[] args) {
        ...
        //초기값(1,2,3)을 가지고 만들어지는 TreeSet객체 생성
        ...
        System.out.println(set4.higher(3)); //인자로 전달된 값보다 큰 데이터 중 최소값 반환. 없으면 null
        System.out.println(set4.higher(7)); //7보다 큰 값이 없기 때문에 null
        System.out.println(set4.lower(3)); //인자로 전달된 값보다 작은 데이터 중 최대값 반환. 없으면 null
        System.out.println(set4.lower(1)); //1보다 작은 값이 없기 때문에 null
